...
INSERT INTO TBL_USUARIO_CLINICA(ID, STR_EMAIL, STR_HASH_KEY, STR_TIPO_PROFISSIONAL) VALUES(2,'paulo@gmail.com',MD5('paulo@gmail.com123456'),'DENTISTA');
INSERT INTO TBL_USUARIO_CLINICA(ID, STR_EMAIL, STR_HASH_KEY, STR_TIPO_PROFISSIONAL) VALUES(3,'marcio@gmail.com', MD5('marcio@gmail.com123456'),'DENTISTA');
...
--PACIENTE
INSERT INTO TBL_PACIENTE(ID, STR_CPF, STR_RG, STR_NOME, STR_GENERO, DTA_DATA_NASCIMENTO, STR_ESTADO_CIVIL, FK_CONTATO, FK_ENDERECO, STR_INDICACAO, STR_PROFISSAO) VALUES(1, '02931612081', '3.912.177', 'ANDRÉ CARDOSO NUNES', 'MASCULINO', '1982-05-15', 'SOLTEIRO', 1, 2, '', 'COMERCIÁRIO');
INSERT INTO TBL_PACIENTE(ID, STR_CPF, STR_RG, STR_NOME, STR_GENERO, DTA_DATA_NASCIMENTO, STR_ESTADO_CIVIL, FK_CONTATO, FK_ENDERECO, STR_INDICACAO, STR_PROFISSAO) VALUES(2, '35409820043', '3987644344', 'JOSE CARLOS PEREIRA', 'MASCULINO', '1970-07-13', 'CASADO', 2, 5, 'RÁDIO', 'MÉDICO');
...
INSERT INTO TBL_PACIENTE(ID, STR_CPF, STR_RG, STR_NOME, STR_GENERO, DTA_DATA_NASCIMENTO, STR_ESTADO_CIVIL, FK_CONTATO, FK_ENDERECO, STR_INDICACAO, STR_PROFISSAO) VALUES(5, '08750941244', '2003009877', 'JOAQUIM DE MORAES', 'MASCULINO', '1936-04-30', 'VIUVO', 11, 8, 'RÁDIO', 'FISIOTERAPEUTA');
INSERT INTO TBL_PACIENTE(ID, STR_CPF, STR_RG, STR_NOME, STR_GENERO, DTA_DATA_NASCIMENTO, STR_ESTADO_CIVIL, FK_CONTATO, FK_ENDERECO, STR_INDICACAO, STR_PROFISSAO) VALUES(6, '00915400920', '3102345677', 'CARLOS ALEXANDRE', 'MASCULINO', '1995-01-31', 'SOLTEIRO', 10, 7, 'FACEBOOK', 'ANALISTA CONTÁBIL');
...
--EVENTO
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, DTA_INICIO, DTA_FIM, FK_TIPO_CONSULTA, FK_PACIENTE, FK_CONVENIO, FK_AGENDA) VALUES(1, FALSE, 'CONCLUIDO', 'NENHUM', '2016-05-10 14:00:00', '2016-05-10 14:30:00', 1, 1, 1, 1);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, DTA_INICIO, DTA_FIM, FK_TIPO_CONSULTA, FK_PACIENTE, FK_CONVENIO, FK_AGENDA) VALUES(2, TRUE, 'ABERTO', 'NENHUM', '2016-05-10 14:00:00', '2016-05-10 14:30:00', 3, 2, 2, 1);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, DTA_INICIO, DTA_FIM, FK_TIPO_CONSULTA, FK_PACIENTE, FK_CONVENIO, FK_AGENDA) VALUES(3, FALSE, 'ABERTO', 'NENHUM', '2016-05-10 14:30:00', '2016-05-10 14:45:00', 2, 3, 2, 1);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, DTA_INICIO, DTA_FIM, FK_TIPO_CONSULTA, FK_PACIENTE, FK_CONVENIO, FK_AGENDA) VALUES(4, FALSE, 'ABERTO', 'NENHUM', '2016-05-10 15:00:00', '2016-05-10 15:30:00', 2, 4, 1, 1);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, DTA_INICIO, DTA_FIM, FK_TIPO_CONSULTA, FK_PACIENTE, FK_CONVENIO, FK_AGENDA) VALUES(5, FALSE, 'ABERTO', 'NENHUM', '2016-05-11 09:00:00', '2016-05-11 09:30:00', 2, 5, 2, 1);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, DTA_INICIO, DTA_FIM, FK_TIPO_CONSULTA, FK_PACIENTE, FK_CONVENIO, FK_AGENDA) VALUES(6, FALSE, 'ABERTO', 'NENHUM', '2016-05-11 10:00:00', '2016-05-11 10:30:00', 3, 6, 1, 1);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, DTA_INICIO, DTA_FIM, FK_TIPO_CONSULTA, FK_PACIENTE, FK_CONVENIO, FK_AGENDA) VALUES(7, FALSE, 'ABERTO', 'NENHUM', '2016-06-08 17:00:00', '2016-06-08 17:30:00', 3, 3, 2, 1);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, DTA_INICIO, DTA_FIM, FK_TIPO_CONSULTA, FK_PACIENTE, FK_CONVENIO, FK_AGENDA) VALUES(8, FALSE, 'ABERTO', 'NENHUM', '2016-06-08 09:30:00', '2016-06-08 09:45:00', 2, 7, 1, 1);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, DTA_INICIO, DTA_FIM, FK_TIPO_CONSULTA, FK_PACIENTE, FK_CONVENIO, FK_AGENDA) VALUES(9, FALSE, 'ABERTO', 'NENHUM', '2016-05-10 09:00:00', '2016-05-10 09:30:00', 1, 2, 2, 2);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, DTA_INICIO, DTA_FIM, FK_TIPO_CONSULTA, FK_PACIENTE, FK_CONVENIO, FK_AGENDA) VALUES(10, FALSE, 'ABERTO', 'NENHUM', '2016-05-10 09:30:00', '2016-05-10 09:45:00', 3, 3, 2, 2);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, DTA_INICIO, DTA_FIM, FK_TIPO_CONSULTA, FK_PACIENTE, FK_CONVENIO, FK_AGENDA) VALUES(11, FALSE, 'ABERTO', 'NENHUM', '2016-05-10 10:00:00', '2016-05-10 10:30:00', 3, 4, 1, 2);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, DTA_INICIO, DTA_FIM, FK_TIPO_CONSULTA, FK_PACIENTE, FK_CONVENIO, FK_AGENDA) VALUES(12, FALSE, 'ABERTO', 'NENHUM', '2016-05-10 10:30:00', '2016-05-10 10:45:00', 2, 5, 2, 2);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, DTA_INICIO, DTA_FIM, FK_TIPO_CONSULTA, FK_PACIENTE, FK_CONVENIO, FK_AGENDA) VALUES(13, FALSE, 'ABERTO', 'NENHUM', '2016-05-10 14:00:00', '2016-05-10 14:30:00', 1, 1, 1, 2);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, DTA_INICIO, DTA_FIM, FK_TIPO_CONSULTA, FK_PACIENTE, FK_CONVENIO, FK_AGENDA) VALUES(14, FALSE, 'ABERTO', 'NENHUM', '2016-05-10 14:30:00', '2016-05-10 14:45:00', 2, 6, 1, 2);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, DTA_INICIO, DTA_FIM, FK_TIPO_CONSULTA, FK_PACIENTE, FK_CONVENIO, FK_AGENDA) VALUES(15, FALSE, 'ABERTO', 'NENHUM', '2016-05-10 15:00:00', '2016-05-10 15:30:00', 2, 8, 1, 2);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, DTA_INICIO, DTA_FIM, FK_TIPO_CONSULTA, FK_PACIENTE, FK_CONVENIO, FK_AGENDA) VALUES(16, FALSE, 'ABERTO', 'NENHUM', '2016-05-10 16:30:00', '2016-05-10 16:45:00', 1, 7, 1, 2);
