...
--EVENTO
INSERT INTO TBL_EVENTO(ID, BOO_CONFIRMADO, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA, NUM_MINUTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(1, TRUE, FALSE, 'CONCLUIDO', 'NENHUM', 2016, 5, 10, 14, 0, 1, 1, 1);
INSERT INTO TBL_EVENTO(ID, BOO_CONFIRMADO, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA, NUM_MINUTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(2, TRUE, TRUE, 'ABERTO', 'NENHUM', 2016, 5, 10, 14, 0, 3, 2, 1);
INSERT INTO TBL_EVENTO(ID, BOO_CONFIRMADO, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA, NUM_MINUTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(3, FALSE, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 14, 30, 2, 3, 1);
INSERT INTO TBL_EVENTO(ID, BOO_CONFIRMADO, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA, NUM_MINUTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(4, FALSE, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 15, 0, 2, 4, 1);
INSERT INTO TBL_EVENTO(ID, BOO_CONFIRMADO, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA, NUM_MINUTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(5, TRUE, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 11, 9, 0, 2, 5, 1);
INSERT INTO TBL_EVENTO(ID, BOO_CONFIRMADO, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA, NUM_MINUTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(6, TRUE, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 11, 10, 0, 3, 6, 1);
INSERT INTO TBL_EVENTO(ID, BOO_CONFIRMADO, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA, NUM_MINUTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(7, TRUE, FALSE, 'ABERTO', 'NENHUM', 2016, 6, 8, 17, 0, 3, 3, 1);
INSERT INTO TBL_EVENTO(ID, BOO_CONFIRMADO, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA, NUM_MINUTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(8, TRUE, FALSE, 'ABERTO', 'NENHUM', 2016, 6, 8, 9, 30, 2, 7, 1);
INSERT INTO TBL_EVENTO(ID, BOO_CONFIRMADO, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA, NUM_MINUTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(9, TRUE, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 9, 0, 1, 2, 2);
INSERT INTO TBL_EVENTO(ID, BOO_CONFIRMADO, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA, NUM_MINUTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(10, TRUE, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 9, 30, 3, 3, 2);
INSERT INTO TBL_EVENTO(ID, BOO_CONFIRMADO, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA, NUM_MINUTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(11, TRUE, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 10, 0, 3, 4, 2);
INSERT INTO TBL_EVENTO(ID, BOO_CONFIRMADO, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA, NUM_MINUTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(12, TRUE, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 10, 30, 2, 5, 2);
INSERT INTO TBL_EVENTO(ID, BOO_CONFIRMADO, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA, NUM_MINUTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(13, TRUE, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 14, 0, 1, 1, 2);
INSERT INTO TBL_EVENTO(ID, BOO_CONFIRMADO, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA, NUM_MINUTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(14, TRUE, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 14, 30, 2, 6, 2);
INSERT INTO TBL_EVENTO(ID, BOO_CONFIRMADO, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA, NUM_MINUTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(15, TRUE, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 15, 0, 2, 8, 2);
INSERT INTO TBL_EVENTO(ID, BOO_CONFIRMADO, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA, NUM_MINUTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(16, TRUE, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 16, 30, 1, 7, 2);