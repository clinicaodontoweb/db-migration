...
INSERT INTO TBL_PACIENTE(ID, STR_CPF, STR_RG, STR_NOME, STR_GENERO, DTA_DATA_NASCIMENTO, STR_ESTADO_CIVIL, FK_CONTATO, FK_ENDERECO, FK_CONVENIO) VALUES(2, '354.098.200-43', '3987644344', 'JOSE CARLOS PEREIRA', 'MASCULINO', '1970-07-13', 'CASADO', 2, 5, 1);
INSERT INTO TBL_PACIENTE(ID, STR_CPF, STR_RG, STR_NOME, STR_GENERO, DTA_DATA_NASCIMENTO, STR_ESTADO_CIVIL, FK_CONTATO, FK_ENDERECO, FK_CONVENIO) VALUES(3, '657.857.388-51', '1439871771', 'MANUELA DOS SANTOS', 'FEMININO', '1966-10-26', 'CASADO', 3, 9, 2);
INSERT INTO TBL_PACIENTE(ID, STR_CPF, STR_RG, STR_NOME, STR_GENERO, DTA_DATA_NASCIMENTO, STR_ESTADO_CIVIL, FK_CONTATO, FK_ENDERECO, FK_CONVENIO) VALUES(4, '899.333.467-61', '3990099949', 'CLEITON XAVIER', 'MASCULINO', '1956-02-29', 'DIVORCIADO', 12, 4, 1);
INSERT INTO TBL_PACIENTE(ID, STR_CPF, STR_RG, STR_NOME, STR_GENERO, DTA_DATA_NASCIMENTO, STR_ESTADO_CIVIL, FK_CONTATO, FK_ENDERECO, FK_CONVENIO) VALUES(5, '087.509.412-44', '2003009877', 'JOAQUIM DE MORAES', 'MASCULINO', '1936-04-30', 'VIUVO', 11, 8, 2);
INSERT INTO TBL_PACIENTE(ID, STR_CPF, STR_RG, STR_NOME, STR_GENERO, DTA_DATA_NASCIMENTO, STR_ESTADO_CIVIL, FK_CONTATO, FK_ENDERECO, FK_CONVENIO) VALUES(6, '009.154.009-20', '3102345677', 'CARLOS ALEXANDRE', 'MASCULINO', '1995-01-31', 'SOLTEIRO', 10, 7, 2);
INSERT INTO TBL_PACIENTE(ID, STR_CPF, STR_RG, STR_NOME, STR_GENERO, DTA_DATA_NASCIMENTO, STR_ESTADO_CIVIL, FK_CONTATO, FK_ENDERECO, FK_CONVENIO) VALUES(7, '157.730.398-34', '9008765433', 'MARINA LOPES E SILVA', 'FEMININO', '1987-12-04', 'CASADO', 4, 11, 1);
INSERT INTO TBL_PACIENTE(ID, STR_CPF, STR_RG, STR_NOME, STR_GENERO, DTA_DATA_NASCIMENTO, STR_ESTADO_CIVIL, FK_CONTATO, FK_ENDERECO, FK_CONVENIO) VALUES(8, '345.921.221-93', '2490399000', 'ELIZANDRA VIEIRA DE SOUZA', 'FEMININO', '1954-08-17', 'DIVORCIADO', 9, 12, 1);

--PROFISSIONAL
INSERT INTO TBL_PROFISSIONAL(ID, STR_NOME, STR_GENERO, STR_CONSELHO, STR_REGISTRO, STR_CODIGO_BRASILEIRO_OCUPACAO, FK_CONTATO) VALUES(1, 'PAULO FERRAZ', 'MASCULINO', 'CRO/SC', '1324', '132', 13);
INSERT INTO TBL_PROFISSIONAL(ID, STR_NOME, STR_GENERO, STR_CONSELHO, STR_REGISTRO, STR_CODIGO_BRASILEIRO_OCUPACAO, FK_CONTATO) VALUES(2, 'MARCIO LONGNE', 'MASCULINO', 'CRO/SC', '2456', '132', 9);
...
INSERT INTO TBL_AGENDA(ID,FK_PROFISSIONAL) VALUES(2, 2);

--EVENTO
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA_INICIO, NUM_HORA_FIM, NUM_MINUTO_INICIO, NUM_MINUTO_FIM, DTA_EVENTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(1, FALSE, 'CONCLUIDO', 'NENHUM', 2016, 5, 10, 14, 14 , 0, 30, '2016-05-10 14:00:00', 1, 1, 1);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA_INICIO, NUM_HORA_FIM, NUM_MINUTO_INICIO, NUM_MINUTO_FIM, DTA_EVENTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(2, TRUE, 'ABERTO', 'NENHUM', 2016, 5, 10, 14, 14, 0, 30, '2016-05-10 14:00:00', 3, 2, 1);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA_INICIO, NUM_HORA_FIM, NUM_MINUTO_INICIO, NUM_MINUTO_FIM, DTA_EVENTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(3, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 14, 14, 30, 45, '2016-05-10 14:30:00', 2, 3, 1);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA_INICIO, NUM_HORA_FIM, NUM_MINUTO_INICIO, NUM_MINUTO_FIM, DTA_EVENTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(4, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 15, 15, 0, 30, '2016-05-10 15:00:00', 2, 4, 1);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA_INICIO, NUM_HORA_FIM, NUM_MINUTO_INICIO, NUM_MINUTO_FIM, DTA_EVENTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(5, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 11, 9, 9, 0, 30, '2016-05-11 09:00:00', 2, 5, 1);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA_INICIO, NUM_HORA_FIM, NUM_MINUTO_INICIO, NUM_MINUTO_FIM, DTA_EVENTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(6, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 11, 10, 10, 0, 30, '2016-05-11 10:00:00', 3, 6, 1);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA_INICIO, NUM_HORA_FIM, NUM_MINUTO_INICIO, NUM_MINUTO_FIM, DTA_EVENTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(7, FALSE, 'ABERTO', 'NENHUM', 2016, 6, 8, 17, 17, 0, 30, '2016-06-08 17:00:00', 3, 3, 1);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA_INICIO, NUM_HORA_FIM, NUM_MINUTO_INICIO, NUM_MINUTO_FIM, DTA_EVENTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(8, FALSE, 'ABERTO', 'NENHUM', 2016, 6, 8, 9, 9, 30, 45, '2016-06-08 09:30:00', 2, 7, 1);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA_INICIO, NUM_HORA_FIM, NUM_MINUTO_INICIO, NUM_MINUTO_FIM, DTA_EVENTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(9, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 9, 9, 0, 30, '2016-05-10 09:00:00', 1, 2, 2);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA_INICIO, NUM_HORA_FIM, NUM_MINUTO_INICIO, NUM_MINUTO_FIM, DTA_EVENTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(10, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 9, 9, 30, 45, '2016-05-10 09:30:00', 3, 3, 2);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA_INICIO, NUM_HORA_FIM, NUM_MINUTO_INICIO, NUM_MINUTO_FIM, DTA_EVENTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(11, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 10, 10, 0, 30, '2016-05-10 10:00:00', 3, 4, 2);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA_INICIO, NUM_HORA_FIM, NUM_MINUTO_INICIO, NUM_MINUTO_FIM, DTA_EVENTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(12, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 10, 10, 30, 45, '2016-05-10 10:30:00', 2, 5, 2);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA_INICIO, NUM_HORA_FIM, NUM_MINUTO_INICIO, NUM_MINUTO_FIM, DTA_EVENTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(13, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 14, 14, 0, 30, '2016-05-10 14:00:00', 1, 1, 2);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA_INICIO, NUM_HORA_FIM, NUM_MINUTO_INICIO, NUM_MINUTO_FIM, DTA_EVENTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(14, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 14, 14, 30, 45, '2016-05-10 14:30:00', 2, 6, 2);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA_INICIO, NUM_HORA_FIM, NUM_MINUTO_INICIO, NUM_MINUTO_FIM, DTA_EVENTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(15, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 15, 15, 0, 30, '2016-05-10 15:00:00', 2, 8, 2);
INSERT INTO TBL_EVENTO(ID, BOO_ENCAIXE, STR_STATUS_EVENTO, STR_OBSERVACAO, NUM_ANO, NUM_MES, NUM_DIA, NUM_HORA_INICIO, NUM_HORA_FIM, NUM_MINUTO_INICIO, NUM_MINUTO_FIM, DTA_EVENTO, FK_TIPO_CONSULTA, FK_PACIENTE, FK_AGENDA) VALUES(16, FALSE, 'ABERTO', 'NENHUM', 2016, 5, 10, 16, 16, 30, 45, '2016-05-10 16:30:00', 1, 7, 2);
