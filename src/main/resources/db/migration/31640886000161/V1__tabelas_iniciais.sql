...
CREATE TABLE TBL_AGENDA(
	ID				bigserial PRIMARY KEY,
	FK_PROFISSIONAL bigint references TBL_PROFISSIONAL (ID)
);
...
CREATE TABLE TBL_EVENTO(
	...
	NUM_HORA_INICIO INTEGER NOT NULL,
	NUM_HORA_FIM INTEGER NOT NULL,
	NUM_MINUTO_INICIO INTEGER NOT NULL,
	NUM_MINUTO_FIM INTEGER NOT NULL,
	DTA_EVENTO TIMESTAMP,
